! function(a) {
	...
	a.fn.circleChart = function(b) {
		...
		return this.each((e, f) => {
			...
			a("canvas.circleChart_canvas", i).length || i.append(function() {
				return a("<canvas/>", {
			...
			a("p.circleChart_text", i).length || !1 !== m.text && (i.append("<p class='circleChart_text'>" + m.text + "</p>"), m.autoCss && (m.textCenter ? a("p.circleChart_text", i).css({
				position: "absolute",
